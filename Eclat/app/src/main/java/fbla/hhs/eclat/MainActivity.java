...
public class MainActivity extends AppCompatActivity implements FlingCardListener.ActionDownInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        al = new ArrayList<>();
        al.add(new Data("http://i.ytimg.com/vi/PnxsTxV8y3g/maxresdefault.jpg", "Zubin sucks", "xxx"));
        al.add(new Data("http://switchboard.nrdc.org/blogs/dlashof/mission_impossible_4-1.jpg", "e master-builder of human happiness.", "xxy"));
